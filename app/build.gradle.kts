...
android {
    namespace = "be.maximedupierreux.drinkmorewater"
    compileSdk = 34

    defaultConfig {
        applicationId = "be.maximedupierreux.drinkmorewater"
        minSdk = 30
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material:material-icons-core-android:1.5.2")
